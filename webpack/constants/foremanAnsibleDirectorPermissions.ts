export const AdPermissions = {
  ansibleContent: {
    view: 'view_ansible_content',
    create: 'create_ansible_content',
  ...
  assignments: {
    view: 'view_ansible_assignments',
    create: 'create_ansible_assignments',
    destroy: 'destroy_ansible_assignments',
  },
};
