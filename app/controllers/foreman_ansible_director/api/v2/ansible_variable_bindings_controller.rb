  ...
  module Api
    module V2
      class AnsibleVariableBindingsController < AnsibleDirectorApiController
        ...
        api :GET, '/v2/ansible_director/ansible_variables/bindings/:id', N_('Show details of a variable binding')
        ...
        api :POST, '/api/v2/ansible_director/ansible_variables/bindings', N_('Create a variable binding')
